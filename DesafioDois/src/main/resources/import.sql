...
INSERT INTO tb_block(start_block, end_block) VALUES (TIMESTAMP WITH TIME ZONE '2017-09-25T08:00:00Z', TIMESTAMP WITH TIME ZONE '2017-09-25T11:00:00');
INSERT INTO tb_block(start_block, end_block) VALUES (TIMESTAMP WITH TIME ZONE '2017-09-25T14:00:00Z', TIMESTAMP WITH TIME ZONE '2017-09-25T18:00:00');
INSERT INTO tb_block(start_block, end_block) VALUES (TIMESTAMP WITH TIME ZONE '2017-09-26T08:00:00Z', TIMESTAMP WITH TIME ZONE '2017-09-26T11:00:00');

INSERT INTO tb_activity(name, description, price, category_id, block_id) VALUES ('Curso de HTML', 'Aprenda HTML de forma prática', '80.00', '1', '2' );
INSERT INTO tb_activity(name, description, price, category_id, block_id) VALUES ('Oficina de GitHub', 'Controle de versões de seus ´projetos', '50.00', '2', '1');
